(function (global, factory) {
    ...
    var ObservableQuery = (function (_super) {
        ...
        ObservableQuery.prototype.currentResult = function () {
            ...
            if (!partial) {
                var stale = false;
                this.lastResult = __assign$1({}, result, { stale: stale });
            }
    ...
    function mergeWithGenerated(generatedKey, realKey, cache) {
        ...
        Object.keys(generated).forEach(function (key) {
            ...
            cache.set(realKey, __assign$7({}, generated, real));
        });
    }
    ...
    function writeFieldToStore(_a) {
        ...
        var newStoreObj = __assign$7({}, store.get(dataId), (_b = {}, _b[storeFieldName] = storeValue, _b));
        if (shouldMerge) {
    ...
    var RecordingCache = (function () {
        ...
        RecordingCache.prototype.toObject = function () {
            return __assign$9({}, this.data, this.recordedData);
        };
        ...
        RecordingCache.prototype.replace = function (newData) {
            this.clear();
            this.recordedData = __assign$9({}, newData);
        };
    ...
    var InMemoryCache = (function (_super) {
        ...
        function InMemoryCache(config) {
            ...
            _this.config = __assign$a({}, defaultConfig, config);
    ...
    var DefaultClient = (function (_super) {
        ...
        function DefaultClient(config) {
            ...
            var stateLink = clientState
                ? withClientState(__assign$c({}, clientState, { cache: cache }))
                : false;
